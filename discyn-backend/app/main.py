...
from app.routes.entrenos import create_entreno, create_entreno_from_rutina, get_entreno, read_entreno, delete_entreno, update_entreno, list_user_entrenos, stats_entreno, user_weekly_summary
